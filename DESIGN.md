...
dark-colors:
  ...
  surface-soft: "#211e1b"
  surface-card: "#2d2926"
  surface-elevated: "#2d2926"
  secondary-bg: "#3a3531"
  secondary-pressed: "#4a4541"
  surface-dark: "#161310"
  hairline: "rgba(255,255,255,0.12)"
  hairline-soft: "rgba(255,255,255,0.24)" 
  ink: "#ffffff"
  ink-soft: "rgba(255,255,255,0.9)"
  body: "rgba(255,255,255,0.85)"
  charcoal: "rgba(255,255,255,0.85)"
  mute: "rgba(255,255,255,0.6)"
  ash: "rgba(255,255,255,0.45)"
  stone: "rgba(255,255,255,0.3)"
  on-secondary: "#ffffff"
  on-dark: "#ffffff"
  ...
  error-deep: "#e60023"
  success-deep: "#30d158"
  success-pale: "rgba(48, 209, 88, 0.2)"
  focus-outer: "#6a85ff"
  focus-inner: "#161310"
  accent-pressed-blue: "#6a85ff"
  accent-purple: "#c060e0"
  accent-purple-deep: "#a34cc2"
