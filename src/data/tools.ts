...
export const tools: Tool[] = [
	...
	},
	{
		id: "color-mixer",
		name: "Color Mixer",
		description: "Mix two colors with adjustable ratio \u2014 output HEX, RGB, HSL.",
		category: "color",
		icon: "blend",
		slug: "color-mixer",
		tags: ["color", "mix", "blend", "gradient", "design"],
	},
	{
		id: "color-shades",
		name: "Color Shades",
		description: "Generate 10 darker shades of any color \u2014 perfect for palettes.",
		category: "color",
		icon: "sun-dim",
		slug: "color-shades",
		tags: ["color", "shades", "darker", "palette", "design"],
	},
	{
		id: "color-tints",
		name: "Color Tints",
		description: "Generate 10 lighter tints of any color \u2014 perfect for palettes.",
		category: "color",
		icon: "sun",
		slug: "color-tints",
		tags: ["color", "tints", "lighter", "palette", "design"],
	},
	...
	},
	{
		id: "json-to-yaml",
		name: "JSON to YAML",
		description: "Convert JSON data to YAML format with customizable indentation.",
		category: "data",
		icon: "file-code",
		slug: "json-to-yaml",
		tags: ["json", "yaml", "convert", "format", "config"],
	},
	{
		id: "tsv-to-json",
		name: "TSV to JSON",
		description: "Convert TSV (tab-separated values) to JSON array with auto-header detection.",
		category: "data",
		icon: "file-json",
		slug: "tsv-to-json",
		tags: ["tsv", "json", "convert", "tab", "data"],
	},
	{
		id: "json-to-tsv",
		name: "JSON to TSV",
		description: "Convert JSON arrays to TSV (tab-separated values) format.",
		category: "data",
		icon: "file-spreadsheet",
		slug: "json-to-tsv",
		tags: ["json", "tsv", "convert", "tab", "data"],
	},
	...
	},
	{
		...
		icon: "search",
		slug: "find-replace",
		tags: ["find", "replace", "search", "text", "regex"],
	},
	{
		id: "whitespace-remover",
		name: "Whitespace Remover",
		description: "Remove extra whitespace, blank lines, and normalize spaces in text.",
		category: "text",
		icon: "eraser",
		slug: "whitespace-remover",
		tags: ["whitespace", "clean", "trim", "spaces", "lines"],
	},
	{
		id: "text-statistics",
		...
		tags: ["statistics", "analysis", "count", "words", "characters"],
	},
	{
		id: "text-wrap",
		name: "Text Wrap",
		description: "Wrap text at a specified character limit with word boundary support.",
		category: "text",
		icon: "wrap-text",
		slug: "text-wrap",
		tags: ["wrap", "line", "break", "format", "column"],
	},
	{
		id: "text-truncate",
		name: "Text Truncate",
		description: "Truncate text to a max length with custom ellipsis and word boundary options.",
		category: "text",
		icon: "scissors",
		slug: "text-truncate",
		tags: ["truncate", "cut", "shorten", "limit", "ellipsis"],
	},
	...
	},
	{
		...
		slug: "ner",
		featured: true,
		tags: ["ner", "entity", "ai", "nlp", "extraction"],
	},
	{
		id: "face-detection",
		name: "Face Detection",
		description: "Detect and blur faces in images using AI. Privacy protection made easy.",
		category: "ai",
		icon: "scan-face",
		slug: "face-detection",
		featured: true,
		tags: ["face", "detection", "ai", "blur", "privacy"],
	},
	{
		id: "paraphrase-generator",
		name: "Paraphrase Generator",
		description: "Rewrite text in different ways using AI. Generate multiple paraphrased versions.",
		category: "ai",
		icon: "repeat-2",
		slug: "paraphrase-generator",
		featured: true,
		tags: ["paraphrase", "rewrite", "ai", "nlp", "generator"],
	},
	{
		id: "language-detector",
		name: "Language Detector",
		description:
			"Detect the language of any text instantly using Unicode analysis. No model download.",
		category: "ai",
		icon: "languages",
		slug: "language-detector",
		featured: true,
		tags: ["language", "detect", "ai", "unicode", "nlp"],
	},
	{
		id: "keyword-extractor",
		name: "Keyword Extractor",
		description: "Extract the most relevant keywords and phrases from text using AI embeddings.",
		category: "ai",
		icon: "key",
		slug: "keyword-extractor",
		featured: true,
		tags: ["keyword", "extract", "ai", "nlp", "embedding"],
	},
	...
	},
	{
		id: "jwt-encoder",
		name: "JWT Encoder",
		description: "Encode JWT tokens with custom header, payload, and secret key.",
		category: "security",
		icon: "lock",
		slug: "jwt-encoder",
		tags: ["jwt", "token", "encode", "auth", "jsonwebtoken"],
	},
	{
		id: "hash-file",
		name: "Hash File",
		description: "Generate SHA-1, SHA-256, SHA-384, SHA-512 hash of any file.",
		category: "security",
		icon: "fingerprint",
		slug: "hash-file",
	...
	},
	{
		...
		tags: ["css", "units", "px", "em", "rem", "convert", "responsive"],
	},
	{
		id: "url-parser",
		name: "URL Parser",
		...
		icon: "link",
		slug: "url-parser",
		tags: ["url", "parse", "query", "params", "components"],
	},
	{
		...
		tags: ["user-agent", "browser", "os", "device", "detect"],
	},
	{
		id: "mime-type-lookup",
		...
		tags: ["mime", "type", "extension", "content-type", "file"],
	},
	{
		id: "http-status-codes",
		name: "HTTP Status Codes",
		description: "Searchable reference of HTTP status codes with descriptions.",
		category: "developer",
		icon: "globe",
	...
	},
	{
		...
		icon: "minimize-2",
		slug: "css-minifier",
		tags: ["css", "minify", "compress", "optimize", "minifier"],
	},
