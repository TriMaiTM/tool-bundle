...
export const categories: Category[] = [
	...
	},
	{
		id: "color",
		name: "Color Tools",
		description: "Pick, convert, generate, and test colors for design and development.",
		icon: "palette",
		color: "#ec4899",
		toolCount: 0,
	},
	{
		...
		description: "Countdown timers, timezone converters, date calculators, and more.",
		icon: "calendar",
		color: "#14b8a6",
		toolCount: 0,
	},
	{
		id: "seo",
		name: "SEO & Marketing",
		description: "Generate meta tags, robots.txt, sitemaps, and optimize for search engines.",
		icon: "search",
		color: "#8b5cf6",
		toolCount: 0,
	},
	...
	},
	{
		id: "fun",
		name: "Fun & Utility",
		description: "Random generators, dice rollers, wheel spinners, and fun tools.",
		icon: "sparkles",
		color: "#f97316",
		toolCount: 0,
	},
	{
		...
		description: "Flashcards, quizzes, grade calculators, citation generators, and study tools.",
		icon: "graduation-cap",
		color: "#6366f1",
		toolCount: 0,
	},
	{
		id: "finance",
		name: "Finance & Money",
		description: "Currency converters, loan calculators, budget trackers, and investment tools.",
		icon: "wallet",
		color: "#84cc16",
		toolCount: 0,
	},
	{
		id: "health",
		name: "Health & Medical",
		description: "BMI, calorie, sleep cycle, body fat calculators and health tools.",
		icon: "heart-pulse",
		color: "#f43f5e",
		toolCount: 0,
	},
	{
		id: "video",
		name: "Video & Audio",
		description: "Convert, trim, compress video and audio files in your browser.",
		icon: "film",
		color: "#d946ef",
		toolCount: 0,
	},
