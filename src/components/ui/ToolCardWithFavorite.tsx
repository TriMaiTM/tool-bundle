...
export default function ToolCardWithFavorite({ tool, category }: Props) {
  ...
  return (
    ...
    >
      ...
      <h3 style="font-size: 16px; font-weight: 600; color: #ffffff; margin-bottom: 6px;">{tool.name}</h3>
      <p style="font-size: 14px; color: #888888; line-height: 1.5; margin: 0;">{tool.description}</p>
    </a>
  );
}
