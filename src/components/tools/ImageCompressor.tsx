			...
			{!file ? (
				...
				<div>
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
						...
						<div
							class={`rounded-lg p-4 ${resultInfo ? "bg-accent-emerald/10 border border-accent-emerald/30" : "bg-surface-elevated"}`}
						>
							<div
								class={`text-caption-uppercase mb-3 ${resultInfo ? "text-accent-emerald" : "text-muted"}`}
							>
								Compressed
							</div>
							{resultInfo ? (
								<div class="text-body-sm text-body">
									...
									<div>
										<strong>Saved:</strong> {resultInfo.saved}
									</div>
								</div>
							) : (
					...
					<div class="mb-6">
						<label class="flex items-center gap-3 text-body-sm">
							<span class="text-caption-uppercase text-muted whitespace-nowrap">
								Max Width (px)
							</span>
							<input
								type="number"
