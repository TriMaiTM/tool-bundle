...
export default function CitationGenerator() {
	...
	const exportBibliography = useCallback(
		(format: "apa" | "mla" | "chicago") => {
			const generator =
				format === "apa" ? generateApa : format === "mla" ? generateMla : generateChicago;
				...
				<div class="bg-surface-elevated rounded-lg p-3">
					<div class="flex items-center justify-between mb-4">
						...
						<div class="flex gap-2">
							...
							<button
								class="btn-secondary text-body-sm"
								onClick={() => exportBibliography("chicago")}
							>
								Export Chicago
							</button>
						</div>
								...
								<div class="flex items-start justify-between gap-3">
									<div class="flex-1 min-w-0">
										<div class="text-body-sm mb-1">
											<span class="badge badge-yellow mr-2">
												{SOURCE_TYPE_LABELS[entry.input.sourceType]}
											</span>
										</div>
