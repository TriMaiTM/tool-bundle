...
const toolComponents: Record<string, ReturnType<typeof lazy>> = {
	...
	"vi-lorem-generator": lazy(() => import("./ViLoremGenerator")),
	"text-cleaner": lazy(() => import("./TextCleaner")),
	"remove-accents": lazy(() => import("./RemoveAccents")),
	"add-line-numbers": lazy(() => import("./AddLineNumbers")),
	"prefix-suffix-lines": lazy(() => import("./PrefixSuffixLines")),
	"text-splitter": lazy(() => import("./TextSplitter")),
	"text-joiner": lazy(() => import("./TextJoiner")),
	"csv-column-extractor": lazy(() => import("./CsvColumnExtractor")),
	"regex-replace-builder": lazy(() => import("./RegexReplaceBuilder")),
	"profanity-filter": lazy(() => import("./ProfanityFilter")),
	...
	"aes-encrypt-decrypt": lazy(() => import("./SecurityAes")),
	"rsa-key-generator": lazy(() => import("./SecurityRsa")),
	"key-matcher": lazy(() => import("./KeyMatcher")),
	"ssh-key-generator": lazy(() => import("./SshKeyGenerator")),
	"pgp-tool": lazy(() => import("./PgpTool")),
	"hmac-validator": lazy(() => import("./HmacValidator")),
	"checksum-verifier": lazy(() => import("./ChecksumVerifier")),
	"secure-notes": lazy(() => import("./SecureNotes")),
	"random-token": lazy(() => import("./RandomToken")),
	"api-key-generator": lazy(() => import("./ApiKeyGenerator")),
	"common-ports": lazy(() => import("./CommonPorts")),
	"security-headers": lazy(() => import("./SecurityHeaders")),
