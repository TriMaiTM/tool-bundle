...
const STOP_WORDS = new Set([
  ...
  "can", "this", "that", "these", "those", "i", "me", "my", "myself", "we", "our",
  "ours", "ourselves", "you", "your", "yours", "yourself", "yourselves", "he", "him",
  "his", "himself", "she", "her", "hers", "herself", "it", "its", "itself", "they",
  "them", "their", "theirs", "themselves", "what", "which", "who", "whom", "when",
  "where", "why", "how", "all", "each", "every", "both", "few", "more", "most",
  "other", "some", "such", "no", "nor", "not", "only", "own", "same", "so", "than",
  "too", "very", "s", "t", "just", "don", "now", "here", "there", "then", "also",
  "about", "up", "out", "if", "into", "over", "after", "before", "between", "through",
  "during", "without", "again", "further", "once", "while", "because", "until", "after",
  "above", "below", "under", "since", "along", "among", "around", "behind", "beside",
  "beyond", "near", "toward", "upon", "against", "within", "even", "still", "already",
  "much", "many", "well", "back", "down", "off", "away", "quite", "really", "always",
  "never", "often", "sometimes", "usually", "almost", "enough", "however", "although",
  "though", "yet", "either", "neither", "whether", "while", "whose", "whichever",
  "whatever", "anything", "everything", "nothing", "something", "anyone", "everyone",
  "someone", "each", "everybody", "anybody", "somebody", "nobody", "let", "make",
  "made", "like", "going", "get", "got", "new", "one", "two", "three", "first",
  "last", "long", "great", "little", "old", "right", "big", "high", "different",
  "small", "large", "next", "early", "young", "important", "few", "public", "bad",
  "same", "able", "using", "used", "use", "per", "via",
]);
  ...
  return (
    <div>
      ...
      <div class="flex flex-wrap items-end gap-4 mb-4">
        <div>
          ...
          <select
            ...
            value={maxHashtags}
            onChange={(e) => setMaxHashtags(Number((e.target as HTMLSelectElement).value) as MaxHashtags)}
          >
            {[5, 10, 15, 20, 30].map((n) => (
      ...
      {text.trim() && keywords.length > 0 && (
        <div class="mb-4">
          <label class="text-caption-uppercase text-muted block mb-2">Top Keywords by Frequency</label>
