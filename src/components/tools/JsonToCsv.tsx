...
const SAMPLE_JSON = JSON.stringify(
  [
    { name: "Alice Johnson", age: 28, email: "alice@example.com", city: "New York", role: "Engineer" },
    { name: "Bob Smith", age: 34, email: "bob@example.com", city: "San Francisco", role: "Designer" },
    { name: "Charlie Brown", age: 22, email: "charlie@example.com", city: "London", role: "Developer" },
    { name: "Diana Prince", age: 30, email: "diana@example.com", city: "Berlin", role: "Manager" },
    { name: "Eve Davis", age: 27, email: "eve@example.com", city: "Tokyo", role: "Analyst" },
  ],
  null,
  2
);
