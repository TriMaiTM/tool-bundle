...
export default function UnixTimestampConverter() {
	...
	const dateFromTimestamp = useMemo(() => {
		...
		const num = Number.parseInt(timestampInput);
	...
	return (
		<div class="space-y-6">
			...
			<div class="bg-surface-elevated rounded-lg p-6 text-center">
				...
				<div class="text-display-sm text-primary" style="font-family: var(--font-mono)">
					{currentTimestamp}
				</div>
					...
					<div class="space-y-4">
						<div>
							...
							<div class="flex items-center gap-3">
								...
								/>
								<button class="btn-secondary text-sm" onClick={fillNow}>
									Now
								</button>
							</div>
						</div>
				...
				<div class="space-y-3">
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								...
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{dateFromTimestamp.toISOString()}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() => handleCopy(dateFromTimestamp.toISOString(), "iso")}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								...
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{formatLocalDate(dateFromTimestamp)}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() => handleCopy(formatLocalDate(dateFromTimestamp), "local")}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								...
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{Math.floor(dateFromTimestamp.getTime() / 1000)}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() =>
									handleCopy(String(Math.floor(dateFromTimestamp.getTime() / 1000)), "sec")
								}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							...
							<button
								class="btn-secondary text-xs"
								onClick={() => handleCopy(String(dateFromTimestamp.getTime()), "ms")}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								<div class="text-caption-uppercase text-muted">Unix Seconds</div>
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{Math.floor(timestampFromDate.getTime() / 1000)}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() =>
									handleCopy(String(Math.floor(timestampFromDate.getTime() / 1000)), "dsec")
								}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								<div class="text-caption-uppercase text-muted">Unix Milliseconds</div>
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{timestampFromDate.getTime()}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() => handleCopy(String(timestampFromDate.getTime()), "dms")}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								<div class="text-caption-uppercase text-muted">ISO 8601</div>
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{timestampFromDate.toISOString()}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() => handleCopy(timestampFromDate.toISOString(), "diso")}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-3">
						<div class="flex items-center justify-between gap-2">
							<div>
								<div class="text-caption-uppercase text-muted">Local</div>
								<code class="code-block text-sm" style="font-family: var(--font-mono)">
									{formatLocalDate(timestampFromDate)}
								</code>
							</div>
							<button
								class="btn-secondary text-xs"
								onClick={() => handleCopy(formatLocalDate(timestampFromDate), "dlocal")}
							>
