			...
			{result && (
				<div class="space-y-4">
					...
					<div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
						...
						<div class="bg-surface-elevated rounded-lg p-3 text-center">
							<div
								class={`text-title-lg ${result.isPastDue ? "text-accent-rose" : "text-primary"}`}
							>
					...
					<div class="bg-surface-elevated rounded-lg p-6">
						...
						<div class="relative mb-6">
							<div class="flex h-6 rounded-full overflow-hidden">
								<div class="bg-accent-blue/40" style="flex: 12" title="Trimester 1" />
								<div class="bg-accent-emerald/40" style="flex: 15" title="Trimester 2" />
								<div class="bg-accent-rose/40" style="flex: 13" title="Trimester 3" />
							</div>
							{/* Current position marker */}
							<div class="absolute top-0 -translate-x-1/2" style={`left: ${result.progressPct}%`}>
								<div class="w-0.5 h-6 bg-white" style="margin: 0 auto" />
								<div
								...
								return (
									<div
										...
										class={`flex items-center gap-3 p-2 rounded-lg ${
											isCurrent ? "bg-surface-soft border border-hairline" : ""
										}`}
									>
										<div
										...
										<div class="flex-1">
											<span class={`text-body-sm ${isPast ? "text-body-strong" : "text-muted"}`}>
						...
						<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
							<div class="flex justify-between p-3 rounded-lg bg-surface-soft">
								...
								<span class="text-body-sm text-primary font-medium">
									{result.lmp.toLocaleDateString("en-US", {
										month: "short",
										day: "numeric",
										year: "numeric",
									})}
					...
					<div class="bg-surface-elevated rounded-lg p-4 flex items-start gap-3">
						...
						<p class="text-body-sm text-muted">
							...
							280-day (40-week) gestation period. Only about 5% of babies are born on their exact
							due date. Consult your healthcare provider for accurate dates and prenatal care.
						</p>
					</div>
				</div>
			)}
