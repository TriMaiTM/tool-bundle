    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-surface-elevated rounded-lg p-6">
            ...
            <div class="flex flex-wrap justify-center gap-2 mt-4">
              ...
              {result.totalCups > 20 && (
                <div class="text-body-sm text-muted self-center">
                  +{result.totalCups - 20} more
                </div>
              )}
            </div>
          </div>
      ...
      {!result && (
        <div class="text-center py-8">
          <p class="text-muted">Enter your weight to calculate your recommended daily water intake.</p>
        </div>
      )}
    </div>
  );
