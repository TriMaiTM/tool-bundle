      ...
      <div class="bg-surface-elevated rounded-lg p-6">
        <div class="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div class="flex-1 w-full">
            <label class="text-caption-uppercase text-muted block mb-2">Enter Color (HEX, RGB, or HSL)</label>
            <input
              type="text"
              class="input w-full"
              value={hexInput}
        ...
        {formats.map((fmt) => (
          <div class="bg-surface-elevated rounded-lg p-3">
            ...
            <div class="flex items-center justify-between gap-2">
              <code class="code-block text-sm flex-1 truncate" style="font-family: var(--font-mono)">
                {fmt.value}
              </code>
              <button
