...
export default function QuestionAnswering() {
  ...
  const highlightedContext = result
    ? context.slice(0, result.start) +
      "【" +
      context.slice(result.start, result.end) +
      "】" +
      context.slice(result.end)
    : context;
          ...
          <div class="card mb-4">
            ...
            <div class="flex items-start gap-3">
              <div
                ...
                style={{ color: "#faff69", lineHeight: 1.2 }}
              >
                💡
              </div>
              <div class="flex-1">
                <div class="text-title-md text-on-dark mb-1">
                  {result.answer}
                </div>
