      ...
      <div class="bg-surface-elevated rounded-lg p-6">
        ...
        {result1 !== null && (
          <div class="bg-surface-elevated rounded-lg p-3 text-center">
            ...
            <div class="text-caption text-muted mt-1">{x1}% of {y1}</div>
          </div>
        )}
      </div>
      ...
      <div class="bg-surface-elevated rounded-lg p-6">
        ...
        {result2 !== null && (
          <div class="bg-surface-elevated rounded-lg p-3 text-center">
            ...
            <div class="text-caption text-muted mt-1">{x2} is {formatNumber(result2)}% of {y2}</div>
          </div>
        )}
      </div>
      ...
      <div class="bg-surface-elevated rounded-lg p-6">
        ...
        {result3 !== null && (
          <div class="grid grid-cols-2 gap-3">
            <div class="bg-surface-elevated rounded-lg p-3 text-center">
              <div class={`text-title-lg ${result3 >= 0 ? "text-accent-emerald" : "text-accent-rose"}`}>
                {result3 >= 0 ? "+" : ""}{formatNumber(result3)}%
              </div>
              <div class="text-caption text-muted mt-1">Change</div>
            </div>
            <div class="bg-surface-elevated rounded-lg p-3 text-center">
              <div class="text-title-lg text-primary">{formatNumber(parseFloat(y3) - parseFloat(x3))}</div>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="bg-surface-elevated rounded-lg p-3 text-center">
              <div class="text-title-lg text-primary">
                {formatNumber(result4 - parseFloat(y4))}
              </div>
              <div class="text-caption text-muted mt-1">{operation === "add" ? "Added" : "Subtracted"}</div>
            </div>
          </div>
        )}
      </div>
