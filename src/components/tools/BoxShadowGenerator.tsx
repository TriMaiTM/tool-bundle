			...
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
				<div>
					...
					<div class="mb-4">
						...
						<input
							...
							max={50}
							value={spread}
							onInput={(e) => setSpread(Number((e.target as HTMLInputElement).value))}
							class="w-full"
						/>
					</div>
					<div class="mb-4">
					...
					<div class="mb-6">
						<label class="flex items-center gap-2 cursor-pointer">
							<input
								type="checkbox"
								checked={inset}
								onChange={(e) => setInset((e.target as HTMLInputElement).checked)}
								class="w-4 h-4"
							/>
				...
				<div class="flex items-center justify-center">
					<div
						...
						style={{ width: 200, height: 200, boxShadow: shadow }}
					/>
				</div>
			</div>
		</div>
