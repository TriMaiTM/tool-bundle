  ...
  return (
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div class="bg-surface-elevated rounded-lg p-3 text-center">
          <div class={`text-title-lg ${summary.balance >= 0 ? "text-accent-emerald" : "text-accent-rose"}`}>
      ...
      <div class="bg-surface-elevated rounded-lg p-6">
        ...
        {filteredTransactions.length === 0 ? (
          <p class="text-muted text-body-sm text-center py-8">No transactions yet. Add one above!</p>
        ) : (
            ...
            <table class="w-full text-body-sm">
              ...
              <tbody>
                {filteredTransactions.map((t) => (
                  <tr key={t.id} class="border-b border-hairline/50 hover:bg-surface-soft/50 transition-colors">
                    ...
                    <td class={`py-2 px-3 text-right font-medium ${t.type === "income" ? "text-accent-emerald" : "text-accent-rose"}`}>
