					...
					{file && file.size > 100 * 1024 * 1024 && (
						<div class="bg-accent-amber/10 border border-accent-amber/30 rounded-lg p-3 mb-4 text-body-sm">
							...
							<span class="text-muted">
								This file is {formatFileSize(file.size)}. Video processing is heavy and may take a
								while. Consider using a smaller file for faster results.
							</span>
						</div>
					)}
					...
					{processedBlob && (
						<div class="bg-surface-elevated rounded-lg p-3 mb-4">
							...
							<div class="text-body-sm text-primary">
								...
								<div>
									<strong>Duration:</strong> {formatDuration(newDuration)}
								</div>
								<div>
									<strong>Size:</strong> {formatFileSize(processedBlob.size)}
								</div>
							</div>
							<video
