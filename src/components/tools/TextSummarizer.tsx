...
export default function TextSummarizer() {
	...
	const handleSummarize = useCallback(async () => {
		...
		try {
			...
			setError(err instanceof Error ? err.message : "Failed to summarize text. Try shorter text.");
			setStatus("error");
		}
	...
	return (
		<div>
			...
			<div class="flex flex-wrap items-end gap-4 mb-4">
				<div>
					<label class="text-caption-uppercase text-muted block mb-1">Min Words</label>
					<input
						type="number"
						class="input"
						style="width: 100px"
				...
				<div>
					<label class="text-caption-uppercase text-muted block mb-1">Max Words</label>
					<input
						type="number"
						class="input"
						style="width: 100px"
			...
			{status === "done" && result && (
				<div>
					<div class="flex items-center gap-3 mb-3">
						...
						{reductionPercent > 0 && (
							<span class="badge badge-yellow">{reductionPercent}% shorter</span>
						)}
						<span class="text-caption text-muted">{summaryWordCount} words</span>
					</div>

					<div class="mb-4">
						<div class="flex items-center justify-between mb-2">
							<label class="text-caption-uppercase text-muted">Summary Output</label>
							<button
						...
						<textarea class="textarea" style="min-height: 160px" value={result} readOnly />
					</div>
