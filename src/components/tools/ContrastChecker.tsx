...
export default function ContrastChecker() {
	...
	const checks = useMemo<CheckResult[]>(
		() => [
			{
				label: "WCAG AA Normal Text (≥ 4.5:1)",
				required: 4.5,
				pass: ratio >= 4.5,
			},
			...
			{
				label: "WCAG AAA Large Text (≥ 4.5:1)",
				required: 4.5,
				pass: ratio >= 4.5,
			},
		],
	...
	return (
		<div class="space-y-6">
			...
			<div class="bg-surface-elevated rounded-lg p-6">
				...
				<div class="rounded-lg p-6" style={{ backgroundColor: background }}>
					<p
						class="text-body-lg mb-2"
						style={{ color: foreground, fontSize: "18px", fontWeight: 600 }}
					>
						Large Text Preview (18px bold)
					</p>
					<p class="text-body" style={{ color: foreground, fontSize: "16px" }}>
						Normal text preview. This is how body text looks with your chosen colors. The quick
