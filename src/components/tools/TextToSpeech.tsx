    ...
    <div>
      ...
      <div class="mb-4">
        ...
        <select
          ...
          onChange={(e) =>
            setSelectedVoiceIdx(Number((e.target as HTMLSelectElement).value))
          }
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div>
          ...
          <input
            ...
            value={pitch}
            onInput={(e) =>
              setPitch(Number((e.target as HTMLInputElement).value))
            }
            class="w-full"
          />
          <div class="flex justify-between text-caption text-muted">
              ...
              return (
                <span
                  ...
                  class={`transition-colors duration-150 ${
                    isActive
                      ? "bg-primary text-on-primary px-0.5 rounded"
                      : "text-body"
                  }`}
                >
                  {word}
      ...
      <div class="bg-surface-elevated rounded-lg p-4">
        <div class="text-body-sm text-muted">
          ...
          {status === "idle" &&
            input.trim() &&
            "Ready — press Play to hear your text"}
        </div>
      </div>
      ...
      <div class="bg-surface-elevated rounded-lg p-4 mt-4">
        ...
        <ul class="text-body-sm text-body space-y-1">
          <li>
            • Uses your browser's built-in Text-to-Speech engine (Web Speech
            API)
          </li>
          <li>• No model download needed — instant processing</li>
          <li>• Voice quality depends on your OS and browser</li>
          <li>
            • Chrome offers ~20 voices, Safari has Siri voices, Edge has
