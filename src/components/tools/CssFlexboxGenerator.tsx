	...
	return (
		<div>
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
				<div>
					<div class="mb-4">
						<label class="text-caption-uppercase text-muted block mb-1">Direction</label>
						<select
							class="input"
							value={direction}
							onChange={(e) => setDirection((e.target as HTMLSelectElement).value)}
						>
					...
					<div class="mb-4">
						<label class="text-caption-uppercase text-muted block mb-1">Justify Content</label>
						<select
							class="input"
							value={justify}
							onChange={(e) => setJustify((e.target as HTMLSelectElement).value)}
						>
					...
					<div class="mb-4">
						<label class="text-caption-uppercase text-muted block mb-1">Align Items</label>
						<select
							class="input"
							value={align}
					...
					<div class="mb-4">
						<label class="text-caption-uppercase text-muted block mb-1">Items: {itemCount}</label>
						<input
							type="range"
							min={2}
							max={12}
							value={itemCount}
							onInput={(e) => setItemCount(Number((e.target as HTMLInputElement).value))}
							class="w-full"
						/>
					</div>
					<div class="mb-4">
