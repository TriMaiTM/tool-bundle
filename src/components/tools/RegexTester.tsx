			...
			<div class="mb-4">
				...
				<div class="flex gap-2">
					<div class="flex-1 relative">
						...
						/>
						<span
							class="absolute right-3 top-1/2 -translate-y-1/2 text-muted-soft"
							style="font-family: var(--font-mono)"
						>
							/
						</span>
					...
					<div
						...
						dangerouslySetInnerHTML={{
							__html: highlightedText
								...
								.replace(
									/&lt;&lt;MARK&gt;&gt;/g,
									'<mark style="background: #faff6930; color: #faff69; border-radius: 2px; padding: 1px 2px">',
								)
								.replace(/&lt;&lt;\/MARK&gt;&gt;/g, "</mark>"),
						}}
					/>
					...
					<div class="space-y-2">
						{matches.map((m, i) => (
							<div class="bg-surface-elevated rounded-lg p-3 flex items-start gap-3">
								<span class="badge-yellow text-caption" style="font-size: 11px">
									#{i + 1}
								</span>
								<div class="flex-1 min-w-0">
									<code
										class="text-body-sm text-primary break-all"
										style="font-family: var(--font-mono)"
									>
										"{m.match}"
									</code>
