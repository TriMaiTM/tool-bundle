...
const CURRENCIES: Currency[] = [
  ...
  { code: "KRW", name: "South Korean Won", symbol: "₩", rate: 1330.00 },
  { code: "VND", name: "Vietnamese Dong", symbol: "₫", rate: 24500.00 },
  ...
  { code: "IDR", name: "Indonesian Rupiah", symbol: "Rp", rate: 15650.00 },
  ...
  { code: "TRY", name: "Turkish Lira", symbol: "₺", rate: 32.00 },
];
        ...
        <div class="space-y-4">
              ...
              <table class="w-full text-body-sm">
                <thead>
                  <tr class="border-b border-hairline">
                    ...
                    <th class="text-right text-caption-uppercase text-muted py-2 px-3">Rate (from USD)</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div class="bg-surface-elevated rounded-lg p-3 text-center">
            ...
            <p class="text-caption text-muted mt-2">
              Rates are approximate and for reference only. They are hardcoded static rates and may not reflect current market conditions.
            </p>
          </div>
        </div>
      )}
