...
export default function OtpGenerator() {
	...
	return (
		<div>
			<div class="mb-6">
				<label class="text-caption-uppercase text-muted block mb-2">Secret Key (Base32)</label>
				<input
					type="text"
					class="input"
			...
			{otp && (
				<div class="bg-surface-elevated rounded-lg p-8 mb-6">
					<div class="text-center mb-6">
						<span class="text-caption-uppercase text-muted block mb-3">Your TOTP Code</span>
						<div class="flex items-center justify-center gap-3">
							...
							<button class="btn-icon-circular" onClick={handleCopy} title="Copy to clipboard">
								{copied ? "✓" : "📋"}
							</button>
						</div>
			...
			{secret && isValidSecret && (
				<div class="bg-surface-elevated rounded-lg p-4">
					<span class="text-caption-uppercase text-muted block mb-2">Configuration</span>
					<div class="grid grid-cols-2 gap-3">
						...
						<div>
							<span class="text-body-sm text-muted-soft block">Code Length</span>
