...
const BMI_CATEGORIES: BmiCategory[] = [
  { label: "Underweight", range: "< 18.5", color: "text-accent-blue", bgColor: "bg-accent-blue" },
  { label: "Normal", range: "18.5 – 24.9", color: "text-accent-emerald", bgColor: "bg-accent-emerald" },
  { label: "Overweight", range: "25 – 29.9", color: "text-warning", bgColor: "bg-warning" },
  { label: "Obese", range: "≥ 30", color: "text-accent-rose", bgColor: "bg-accent-rose" },
];
...
export default function BmiCalculator() {
  ...
  const bmi = useMemo(() => {
    ...
    if (isNaN(w) || w <= 0 || hCm === null || hCm <= 0) return null;
  ...
  const handleWeightUnitChange = useCallback((unit: WeightUnit) => {
    ...
    if (!isNaN(currentWeight) && weight.trim() !== "") {
              ...
              <div class="flex rounded-md overflow-hidden border border-hairline">
                <button
                  class={`px-3 py-1 text-body-sm font-medium transition-colors ${
                    weightUnit === "kg" ? "bg-primary text-on-primary" : "bg-surface-elevated text-body hover:text-on-dark"
                  }`}
                ...
                <button
                  class={`px-3 py-1 text-body-sm font-medium transition-colors ${
                    weightUnit === "lb" ? "bg-primary text-on-primary" : "bg-surface-elevated text-body hover:text-on-dark"
                  }`}
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <div class="flex rounded-md overflow-hidden border border-hairline">
                <button
                  class={`px-3 py-1 text-body-sm font-medium transition-colors ${
                    heightUnit === "cm" ? "bg-primary text-on-primary" : "bg-surface-elevated text-body hover:text-on-dark"
                  }`}
                ...
                <button
                  class={`px-3 py-1 text-body-sm font-medium transition-colors ${
                    heightUnit === "ftin" ? "bg-primary text-on-primary" : "bg-surface-elevated text-body hover:text-on-dark"
                  }`}
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div class="bg-surface-elevated rounded-lg p-3 text-center">
              ...
              <div class="text-caption text-muted mt-1">
                {bmi < 18.5 ? "kg/m² to Normal" : bmi > 24.9 ? "kg/m² above Normal" : "Within Range"}
              </div>
            </div>
          </div>
          ...
          <div class="bg-surface-elevated rounded-lg p-6">
            ...
            <div class="relative mt-8 mb-4">
              ...
              <div class="flex h-4 rounded-full overflow-hidden">
                <div class="bg-accent-blue" style="flex: 8.5"></div>
                <div class="bg-accent-emerald" style="flex: 6.4"></div>
                <div class="bg-warning" style="flex: 5"></div>
                <div class="bg-accent-rose" style="flex: 10.1"></div>
              </div>
              {/* Indicator */}
              {position !== null && (
                <div
                  ...
                  style={`left: ${position}%`}
                >
                  <div class="w-0.5 h-4 bg-white" style="margin: 0 auto"></div>
                  <div
            ...
            <div class="flex text-caption text-muted mt-2">
              <div style="flex: 8.5" class="text-center">Underweight</div>
              <div style="flex: 6.4" class="text-center">Normal</div>
              <div style="flex: 5" class="text-center">Overweight</div>
              <div style="flex: 10.1" class="text-center">Obese</div>
            </div>
          </div>
              ...
              {BMI_CATEGORIES.map((cat) => (
                ...
                >
                  <div class="flex items-center gap-3">
                    <div class={`w-3 h-3 rounded-full ${cat.bgColor}`}></div>
