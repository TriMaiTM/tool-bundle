      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div>
          ...
          <input
            ...
            min={1}
            max={4000}
            onInput={(e) => setWidth(Math.max(1, parseInt((e.target as HTMLInputElement).value) || 1))}
          />
        </div>
        <div>
          ...
          <input
            ...
            min={1}
            max={4000}
            onInput={(e) => setHeight(Math.max(1, parseInt((e.target as HTMLInputElement).value) || 1))}
          />
        </div>
        <div>
