      ...
      {!file ? (
        ...
        <div>
          ...
          <div class="bg-surface-elevated rounded-lg p-3 mb-4">
            ...
            {/* Sample rate */}
            <div class="mt-4">
              <label class="text-body-sm text-primary mb-2 block">
                Sample Rate
              </label>
              <select
                class="input w-full"
          ...
          {convertedBlob && audioInfo && (
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <div class="rounded-lg p-4 bg-accent-emerald/10 border border-accent-emerald/30">
                <div class="text-caption-uppercase text-accent-emerald mb-3">
                  Converted
                </div>
                <div class="text-body-sm text-primary">
                  <div>
                  ...
                  <div>
                    <strong>Sample Rate:</strong> {sampleRate.toLocaleString()}{" "}
                    Hz
                  </div>
                </div>
              </div>
          ...
          <div class="bg-surface-elevated rounded-lg p-3 mb-4 text-body-sm text-muted">
            <strong>Note:</strong> Browser supports WAV and OGG output. For MP3,
            a dedicated tool is needed.
          </div>
