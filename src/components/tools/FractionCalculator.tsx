...
export default function FractionCalculator() {
  ...
  const parseFraction = useCallback((f: FractionInput): [number, number] | null => {
    const num = parseInt(f.num);
    const den = parseInt(f.den);
            ...
            <div class="flex flex-wrap items-center gap-4">
              ...
              <div class="flex flex-col items-center gap-1">
                <input
                  ...
                  placeholder="Num"
                  value={f1.num}
                  onInput={(e) => setF1(prev => ({ ...prev, num: (e.target as HTMLInputElement).value }))}
                />
                ...
                <input
                  ...
                  placeholder="Den"
                  value={f1.den}
                  onInput={(e) => setF1(prev => ({ ...prev, den: (e.target as HTMLInputElement).value }))}
                />
              </div>
                ...
                {(["add", "subtract", "multiply", "divide"] as Operation[]).map((op) => (
                  <button
                    ...
                    class={`px-3 py-1 rounded text-body-sm ${
                      operation === op ? "bg-primary text-on-primary" : "bg-surface-elevated text-body hover:text-on-dark"
                    }`}
              ...
              <div class="flex flex-col items-center gap-1">
                <input
                  ...
                  placeholder="Num"
                  value={f2.num}
                  onInput={(e) => setF2(prev => ({ ...prev, num: (e.target as HTMLInputElement).value }))}
                />
                <div class="w-20 h-[2px] bg-primary"></div>
                <input
                  type="number"
                  ...
                  placeholder="Den"
                  value={f2.den}
                  onInput={(e) => setF2(prev => ({ ...prev, den: (e.target as HTMLInputElement).value }))}
                />
              </div>
            </div>
          </div>
              ...
              <div class="bg-surface-elevated rounded-lg p-3">
                <div class="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    onClick={() => copyResult(`${calculation.simplifiedNum}/${calculation.simplifiedDen}`)}
                  >
          ...
          <div class="bg-surface-elevated rounded-lg p-3">
            ...
            <div class="flex items-center gap-4">
              <div class="flex flex-col items-center gap-1">
                ...
                />
                <div class="w-24 h-[2px] bg-primary"></div>
                <input
                  type="number"
                  class="input w-24 text-center"
        ...
        <div class="space-y-6">
          ...
          {comparisonResult && (
            <div class="bg-surface-elevated rounded-lg p-6 text-center">
              ...
              <div class={`badge ${comparisonResult.relation === "equal" ? "badge-yellow" : comparisonResult.relation === "greater" ? "bg-accent-emerald text-white" : "bg-accent-rose text-white"}`}>
                {comparisonResult.relation === "equal"
                  ? "Equal"
                  : comparisonResult.relation === "greater"
                    ? "Greater Than"
