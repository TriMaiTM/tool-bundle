      ...
      <div class="space-y-3">
        {ALGORITHMS.map((algo) => (
          <div class="bg-surface-elevated rounded-lg p-4">
            ...
            <code class="text-body-sm text-body-strong break-all" style="font-family: var(--font-mono)">
              {hashes[algo] || <span class="text-muted-soft">Enter text above to generate hash...</span>}
            </code>
          </div>
        ))}
      </div>
