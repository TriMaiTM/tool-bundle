				...
				<div>
					...
					<div class="mb-4">
						...
						<select
							class="input"
							value={colSize}
							onChange={(e) => setColSize((e.target as HTMLSelectElement).value)}
						>
					...
					<div class="mb-4">
						...
						<select
							class="input"
							value={rowSize}
							onChange={(e) => setRowSize((e.target as HTMLSelectElement).value)}
						>
							<option value="auto">auto</option>
							<option value="1fr">1fr (equal)</option>
							<option value="min-content">min-content</option>
				...
				<div class="flex items-center justify-center">
					...
					>
						{Array.from({ length: cols * rows }).map((_, i) => (
							<div
								key={i}
								class="bg-primary/20 border border-primary/40 rounded-md flex items-center justify-center text-body-sm text-primary"
								style={{ minHeight: 60 }}
							>
								{i + 1}
							</div>
