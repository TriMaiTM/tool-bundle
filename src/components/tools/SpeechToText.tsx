...
export default function SpeechToText() {
	...
	return (
		<div>
			...
			{mode === "file" && (
				<div class="mb-4">
					<label class="text-caption-uppercase text-muted block mb-2">Audio File</label>
					<div class="drop-zone" style="padding: 24px">
						...
						<label
							...
							class="cursor-pointer text-body-sm text-primary hover:text-primary-active"
						>
					...
					{file && (
						<div class="mt-3 bg-surface-elevated rounded-lg p-3 flex items-center gap-3">
							...
							<button class="text-body-sm text-accent-rose" onClick={handleReset}>
								Remove
							</button>
						</div>
					)}
			...
			{mode === "microphone" && (
				<div class="mb-4">
					<label class="text-caption-uppercase text-muted block mb-2">Record Audio</label>
					<div class="bg-surface-elevated rounded-lg p-6 text-center">
						{!isRecording && !recordedBlob && (
							<div>
								<button class="btn-primary" onClick={startRecording} disabled={isProcessing}>
									🎙 Start Recording
								</button>
						...
						{isRecording && (
							<div>
								<div
									class="text-display-sm text-accent-rose mb-2"
			...
			{hasAudio && status !== "done" && (
				<div class="mb-4">
					<button class="btn-primary" onClick={handleTranscribe} disabled={isProcessing}>
			...
			{status === "done" && result && (
				<div>
					...
					<div class="mb-4">
						...
						<textarea class="textarea" style="min-height: 200px" value={result} readOnly />
					</div>
