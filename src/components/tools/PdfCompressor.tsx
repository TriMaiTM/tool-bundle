...
export default function PdfCompressor() {
  ...
  const savedPercent = compressedSize !== null && originalSize > 0
      ...
      {!file ? (
        ...
        <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div class={`rounded-lg p-4 ${compressedSize !== null ? "bg-accent-emerald/10 border border-accent-emerald/30" : "bg-surface-elevated"}`}>
              <div class={`text-caption-uppercase mb-3 ${compressedSize !== null ? "text-accent-emerald" : "text-muted"}`}>
                Compressed
              </div>
              {compressedSize !== null ? (
                <div class="text-body-sm text-body">
                  ...
                  <div><strong>Saved:</strong> {savedBytes > 0 ? formatFileSize(savedBytes) : "0 B"}</div>
                </div>
              ) : (
            ...
            <div class="space-y-3">
              <label class="flex items-center gap-3 text-body-sm cursor-pointer">
                ...
                <div>
                  ...
                  <div class="text-caption text-muted">Strip title, author, keywords, and other document properties</div>
                </div>
              </label>
              <label class="flex items-center gap-3 text-body-sm cursor-pointer">
                <input
                ...
                <div>
                  ...
                  <div class="text-caption text-muted">Optimize internal PDF structure for smaller file size</div>
                </div>
              </label>
            </div>
          </div>
          ...
          <div class="bg-accent-amber/10 border border-accent-amber/30 rounded-lg p-4 mb-6 text-body-sm text-accent-amber">
            <strong>Note:</strong> pdf-lib provides basic compression through metadata removal and object stream optimization. For advanced image compression, consider using a dedicated PDF optimization service.
          </div>
